          ...
          <div class="hero-panel">
            ...
            <div class="panel-body">
              <label class="field">
                ...
                <textarea rows="7" placeholder="Paste your Ouru text here..."></textarea>
              </label>
              <div class="field-row">
                <label class="field">
              ...
              <label class="field">
                <span>File name</span>
                <input type="text" placeholder="ouru-report-q1" />
              </label>
              <button class="btn primary wide">Convert now</button>
            </div>
          </div>
        </div>
      </section>
